...
export const postSchedule = async (
	...
	try {
		...
		console.error("Erro no postSchedule:", error);
...
export const patchSchedule = async (
	...
	try {
		...
		console.error("Erro no patchSchedule:", error);
		throw error; // Propaga o erro para quem chamar a função
	}
};
...
export const getSchedule = async (
	...
	try {
		...
		console.error("Erro no getSchedule:", error);
		throw error; // Propaga o erro para quem chamar a função
	}
};
...
export const getScheduleDates = async (teacherId: string) => {
	try {
		...
		console.error("Erro no getScheduleDates:", error);
		throw error; // Propaga o erro para quem chamar a função
	}
};
...
export const getScheduleDatesByStudent = async (
	...
	try {
		...
		console.error("Erro no getScheduleDatesByStudent:", error);
		throw error; // Propaga o erro para quem chamar a função
	}
};
...
export const getScheduleById = async (
	...
	try {
		...
		console.error("Erro no getScheduleById:", error);
		throw error; // Propaga o erro para quem chamar a função
	}
};
...
export const deleteScheduleById = async (
	...
	try {
		...
		console.error("Erro no deleteScheduleById:", error);
		throw error; // Propaga o erro para quem chamar a função
	}
};
