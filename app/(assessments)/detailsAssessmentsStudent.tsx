        ...
        <View style={{ display: 'flex', gap: 16 }}>
          <Card>
            ...
            <Card.Content style={{ gap: 10 }}>
              <InfoField
                description={
                  `${String(assessmentsByStudent?.bodyMeasurements?.weight)} kg` ||
                  ''
                }
                style={{
                  flexDirection: 'row',
              ...
              <InfoField
                description={
                  `${String(assessmentsByStudent?.bodyMeasurements?.height)} cm` ||
                  ''
                }
                style={{
                  flexDirection: 'row',
              ...
              <InfoField
                description={
                  `${String(assessmentsByStudent?.bodyMeasurements?.bodyFatPercentage)} %` ||
                  ''
                }
                style={{
                  flexDirection: 'row',
          ...
          <Card>
            ...
            <Card.Content style={{ gap: 10 }}>
              <InfoField
                description={
                  `${String(assessmentsByStudent?.bodyMeasurements?.waistCircumference)} cm` ||
                  ''
                }
                style={{
                  flexDirection: 'row',
              ...
              <InfoField
                description={
                  `${String(assessmentsByStudent?.bodyMeasurements?.hipCircumference)} cm` ||
                  ''
                }
                style={{
                  flexDirection: 'row',
              ...
              <InfoField
                description={
                  `${String(assessmentsByStudent?.bodyMeasurements?.chestCircumference)} cm` ||
                  ''
                }
                style={{
                  flexDirection: 'row',
              ...
              <InfoField
                description={
                  `${String(assessmentsByStudent?.bodyMeasurements?.neckCircumference)} cm` ||
                  ''
                }
                style={{
                  flexDirection: 'row',
          ...
          <Card>
            ...
            <Card.Content style={{ gap: 10 }}>
              <InfoField
                description={
                  `${String(assessmentsByStudent?.bodyMeasurements?.rightArmCircumference)} cm` ||
                  ''
                }
                style={{
                  flexDirection: 'row',
              ...
              <InfoField
                description={
                  `${String(assessmentsByStudent?.bodyMeasurements?.leftArmCircumference)} cm` ||
                  ''
                }
                style={{
                  flexDirection: 'row',
          ...
          <Card>
            ...
            <Card.Content style={{ gap: 10 }}>
              <InfoField
                description={
                  `${String(assessmentsByStudent?.bodyMeasurements?.rightThighCircumference)} cm` ||
                  ''
                }
                style={{
                  flexDirection: 'row',
              ...
              <InfoField
                description={
                  `${String(assessmentsByStudent?.bodyMeasurements?.leftThighCircumference)} cm` ||
                  ''
                }
                style={{
                  flexDirection: 'row',
              ...
              <InfoField
                description={
                  `${String(assessmentsByStudent?.bodyMeasurements?.rightCalfCircumference)} cm` ||
                  ''
                }
                style={{
                  flexDirection: 'row',
              ...
              <InfoField
                description={
                  `${String(assessmentsByStudent?.bodyMeasurements?.leftCalfCircumference)} cm` ||
                  ''
                }
                style={{
                  flexDirection: 'row',
          ...
          <Card>
            ...
            <Card.Content style={{ gap: 10 }}>
              <InfoField
                description={
                  `${String(assessmentsByStudent?.bodyMass?.muscleMass)} kg` ||
                  ''
                }
                style={{
                  flexDirection: 'row',
              ...
              <InfoField
                description={
                  `${String(assessmentsByStudent?.bodyMass?.boneMass)} kg` || ''
                }
                style={{
                  flexDirection: 'row',
                  alignItems: 'center',
          ...
          <Card>
            ...
            <Card.Content style={{ gap: 10 }}>
              <InfoField
                description={
                  `${String(assessmentsByStudent?.heartRate?.restingHeartRate)} bpm` ||
                  ''
                }
                style={{
                  flexDirection: 'row',
              ...
              <InfoField
                description={
                  `${String(assessmentsByStudent?.heartRate?.maxHeartRate)} bpm` ||
                  ''
                }
                style={{
                  flexDirection: 'row',
          ...
          <Card>
            ...
            <Card.Content style={{ gap: 10 }}>
              <InfoField
                description={
                  String(assessmentsByStudent?.medicalHistory?.injuryHistory) ||
                  'Não informado.'
                }
              ...
              <InfoField
                description={
                  String(assessmentsByStudent?.medicalHistory?.chronicPain) ||
                  'Não informado.'
                }
          ...
          <Card>
            ...
            <Card.Content style={{ gap: 10 }}>
              ...
              <InfoField
                description={
                  String(assessmentsByStudent?.posture?.postureAssessment) ||
                  'Não informado.'
                }
                style={{
                  flexDirection: 'row',
